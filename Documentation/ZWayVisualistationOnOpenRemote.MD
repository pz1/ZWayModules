...
----
## Appendix XX: Installation of OpenRemote controller 2.6.0 (Beta1) on RaspberryPi      
...
- For a first trial on the RaspberryPi console cd /opt/openremote/bin. Next give command:  
      **bash openremote.sh run**
