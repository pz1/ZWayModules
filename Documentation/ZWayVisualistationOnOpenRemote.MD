...
**/opt/openremote/webapps/controller/WEB-INF/classes/log4j.properties**. In the first line of that file, do change the default level INFO into OFF. Reboot RaspberryPi.           
