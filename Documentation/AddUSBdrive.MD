...
To assure that the drive is automatically available after every reboot, add the last line to /etc/fstab. !!I also made the boot partition read_only, and added the noatime flag!!.    
